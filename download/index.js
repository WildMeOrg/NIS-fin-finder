...
module.exports = async function (context, req) {
    try {
        ...
        if(reqQuery.type === 'training'){
           ...
           const https = require('https'); // or 'https' for https:// URLs
            ...
            errArr.push(utils.errorObject('DF001',AppConstant.EC.INVALI_VALUE,AppConstant.EC.INVALI_VALUE));
    ...
    /* const reqQuery = req.query;
    authHelper.isValidUser(req).then((res)=>{
        //req.userDetail = res;
        utils.sendResponse(context,req,200,req.userDetail);
    }).catch((error)=>{
